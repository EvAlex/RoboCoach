...
declare namespace firebase {
    ...
    export class Auth {        
        ...
        GithubAuthProider: GithubAuthProider;

        TwitterAuthProvider: TwitterAuthProvider;

        /**
         * Adds an observer for auth state changes.
         * @param {(user: User) => void | Observer} nextOrObserver An observer object or a function triggered on change.
         * @param {AuthError} opt_error A function triggered on auth error.
         * @param {() => void} opt_completed A function triggered when the observer is removed.
         */
        onAuthStateChanged(nextOrObserver: (user: User) => void | Observer, opt_error?: (err: AuthError) => void, opt_completed?: () => void): UnsubscribeFn;
    }
